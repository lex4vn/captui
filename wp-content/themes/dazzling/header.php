		...
		<div class="container">
			<div class="row">
				...
				<?php if( get_header_image() != '' ) : ?>
					...
					<div id="logo" class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="search-box col-lg-4 col-md-6 col-sm-6 col-xs-12">
					<?php get_search_form(); ?>
				</div>
				<div class="hotline col-lg-4 col-md-6 col-sm-6 col-xs-12">
